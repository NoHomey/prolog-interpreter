...
main = do
    let rs = rules prog
    let as = [a, b]
    let mrs = PDB.transformRules (+1) (+1) (+1) (1, et) rs :: State ((Int, C), (Int, C)) (PRs.Rules Int Int)
    let mas = PDB.transformAtoms (+1) (+1) (+1) as :: State ((Int, C), (Int, C), (Int, C)) (PRs.Atoms Int Int)
